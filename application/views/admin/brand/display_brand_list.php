...
<div id="content">
		<div class="grid_container">
			<?php 
				...
				echo form_open(ADMIN_ENC_URL.'/brand/change_brand_status_global',$attributes) 
			?>
			<div class="grid_12">
					...
					<div class="widget_top">
						...
						<?php if ($allPrev == '1' || in_array('1', $brand)){?>
							...
							<div class="btn_30_light" style="height: 29px; text-align:left;">
								<a href="<?php echo ADMIN_ENC_URL;?>/brand/add_brand_form" class="tipTop" title="<?php if ($this->lang->line('make_model_add_new_brand') != '') echo stripslashes($this->lang->line('make_model_add_new_brand')); else echo 'Click here to Add New Brand'; ?>"><span class="icon add_co addnew-btn2"></span> <!-- <span class="btn_link"><?php if ($this->lang->line('admin_car_add_new') != '') echo stripslashes($this->lang->line('admin_car_add_new')); else echo 'Add New'; ?></span> --></a>
							</div>
							...
							<tbody>
								...
								<tr>
									...
									if ($allPrev == '1' || in_array('2', $brand)){
										...
										if ($mode == '0'){
									?>
										<a title="<?php if ($this->lang->line('common_click_inactive') != '') echo stripslashes($this->lang->line('common_click_inactive')); else echo 'Click to inactive'; ?>" class="tip_top" href="javascript:confirm_status('<?php echo ADMIN_ENC_URL;?>/brand/change_brand_status/<?php echo $mode;?>/<?php echo $row->_id;?>');"><span class="badge_style b_done"><?php echo $disp_status;?></span></a>
									<?php
										}else {	
									?>
										<a title="<?php if ($this->lang->line('common_click_active') != '') echo stripslashes($this->lang->line('common_click_active')); else echo 'Click to active'; ?>" class="tip_top" href="javascript:confirm_status('<?php echo ADMIN_ENC_URL;?>/brand/change_brand_status/<?php echo $mode;?>/<?php echo $row->_id;?>')"><span class="badge_style"><?php echo $disp_status;?></span></a>
									<?php 
										}
									}else {
									?>
