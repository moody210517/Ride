...
?>
<div id="content" class="admin-settings edit_user_set">
        ...
        <div class="grid_12">
            <div class="widget_wrap">
                ...
                <div class="widget_content chenge-pass-base">
					<?php
					$attributes = array('class' => 'form_container left_label', 'id' => 'addeditmodel_form','method'=>'POST','enctype' => 'multipart/form-data');
					echo form_open(ADMIN_ENC_URL.'/brand/insertEditModel', $attributes)
					?>
                        <div>
                        <ul class="leftsec-contsec add-edit-modal">
                        <li>
						<div class="form_grid_12">
						<label class="field_title"><?php if ($this->lang->line('admin_make_and_model_model_list_maker') != '') echo stripslashes($this->lang->line('admin_make_and_model_model_list_maker')); else echo 'Maker'; ?> <span class="req">*</span></label>
						...
						<label class="field_title"><?php if ($this->lang->line('admin_make_and_model_model_list_model_name') != '') echo stripslashes($this->lang->line('admin_make_and_model_model_list_model_name')); else echo 'Model Name'; ?> <span class="req">*</span></label>
							<div class="form_input">
								<input name="name" id="name" type="text"  class="large tipTop required" title="<?php if ($this->lang->line('make_model_document_name') != '') echo stripslashes($this->lang->line('make_model_document_name')); else echo 'Please enter document name'; ?>" value="<?php
								if ($form_mode) {
						...
						<li>
						<div class="form_grid_12">
						<label class="field_title"><?php if ($this->lang->line('admin_make_and_model_Vehicle_list_model_type') != '') echo stripslashes($this->lang->line('admin_make_and_model_Vehicle_list_model_type')); else echo 'Vehicle Type'; ?> <span class="req">*</span></label>
