...
<div id="content" class="revenue-base-sec">
	<div class="grid_container">
										...
										<select name="date_range" id="date_range">
											...
											<?php
												...
												if($bill_period_from==$bill_period_to){
													...
													$bill_val=get_time_to_string("m/d/Y",MongoEPOCH($bill->bill_period_from)).' - '.get_time_to_string("m/d/Y",MongoEPOCH($bill->bill_period_to));
		...
		<?php 
			...
			echo form_open(ADMIN_ENC_URL.'/revenue/display_site_revenue',$attributes) 
		?>
			<div class="grid_12">
				<div class="widget_wrap">
					<div class="widget_top">
						...
						<div style="float: right;line-height:40px;padding:0px 10px;height:39px;">
								...
								?>
								<div class="btn_30_light" style="margin:0;">
					...
					<div class="widget_content">
							...
							<div class="social_activities second-tab cabily_dash inner_site_revenue">								
							...
							<thead>
								<tr>
									<th class="tip_top" title="<?php if ($this->lang->line('dash_click_sort') != '') echo stripslashes($this->lang->line('dash_click_sort')); else echo 'Click to sort'; ?>">
										<?php if ($this->lang->line('admin_drivers_driver_name') != '') echo stripslashes($this->lang->line('admin_drivers_driver_name')); else echo 'Driver Name'; ?>
									</th>
									<th class="tip_top" title="<?php if ($this->lang->line('dash_click_sort') != '') echo stripslashes($this->lang->line('dash_click_sort')); else echo 'Click to sort'; ?>">
									...
									<th>
										<?php if ($this->lang->line('admin_site_earnings_action') != '') echo stripslashes($this->lang->line('admin_site_earnings_action')); else echo 'Action'; ?>
									</th>
								</tr>
							</thead>
							<tbody>
								...
								<tr>
									...
									*/ ?>
									...
									<td class="center action-icons-wrap">
										...
										?>
											<span>
												<a class="action-icons c-suspend" href="<?php echo ADMIN_ENC_URL;?>/revenue/driver_trip_summary/<?php echo $driver['id'].$urlVal; ?>" title="<?php if ($this->lang->line('site_earning_view_summary') != '') echo stripslashes($this->lang->line('site_earning_view_summary')); else echo 'View Summary'; ?>">
	...
	$(function () {
		$("#billFromdate").datepicker({  
            ...
            onSelect: function(dateStr){
                $("#billTodate").datepicker("destroy");
                $("#billTodate").val(dateStr);
                $("#billTodate").datepicker({ minDate: new Date(dateStr),maxDate: '<?php echo date('m/d/Y'); ?>'})
            }
        });
		...
		$("#billTodate").datepicker({  
            maxDate: '<?php echo date('m/d/Y'); ?>',
            minDate: '<?php if($fromdate != '') echo date('m/d/Y',strtotime($fromdate)); else echo date('m/d/Y'); ?>',
            /* onSelect: function(dateStr){
                $("#billFromdate").datepicker("destroy");
                $("#billFromdate").val(dateStr);
                $("#billFromdate").datepicker({ maxDate: new Date(dateStr)})
            } */
        });
