...
<div id="content">
    <div class="grid_container">
        ...
        <div class="grid_12">
            <div class="widget_wrap">
                <div class="widget_top">
                    ...
                    <h6><?php if ($this->lang->line('admin_site_earnings_revenue_summary') != '') echo stripslashes($this->lang->line('admin_site_earnings_revenue_summary')); else echo 'Revenue Summary Details'; ?> : <?php echo $fromdate . ' - ' . $todate; ?></h6>
                        ...
                        <table class="custom-table tbl-open-close">
                            ...
                            <tbody>
                                ...
                                foreach ($rideList as $ride) {
									...
									$pay_type=str_replace("_"," & ",$pay_type);
        ...
        <div id="payment_paid" style="display:none;">
			...
			<?php
			$attributes = array('class' => 'form_container left_label', 'id' => 'payment_paid_form','method'=>'POST','autocomplete'=>'off','enctype' => 'multipart/form-data');
			echo form_open(ADMIN_ENC_URL.'/revenue/transaction/paid', $attributes)
			?>
        ...
        <div id="payment_received" style="display:none;">
			...
			<?php
			$attributes = array('class' => 'form_container left_label', 'id' => 'payment_received_form','method'=>'POST','autocomplete'=>'off','enctype' => 'multipart/form-data');
			echo form_open(ADMIN_ENC_URL.'/revenue/transaction/received', $attributes)
			?>
				<input name="invoice_id"  id="invoice_id" value="<?php echo $bill_details['invoice_id']; ?>" type="hidden"  />
                <table>
                    <tr>
...
<?php echo get_time_to_string('d',MongoEPOCH($bill_details['bill_date']));?>
...
$("#received_date").datetimepicker({
	...
	changeYear: true,
	changeMonth: true,
	//minDate: new Date(<?php echo date('Y',$bill_details['bill_date']->sec);?>, <?php echo date('m',$bill_details['bill_date']->sec);?> - 1, <?php echo date('d',$bill_details['bill_date']->sec);?>),
	minDate: new Date("<?php echo date('Y-m-d',MongoEPOCH($bill_details['bill_date']));?>"),
	maxDate: new Date(),
	controlType: 'select',
	oneLine: true,
	timeFormat: "hh:mm TT",
