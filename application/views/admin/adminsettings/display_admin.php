				...
				<div class="widget_wrap">
					...
					<div class="widget_content">
						...
						<tr>
							...
							<?php }else {?>
								<a href="javascript:confirm_status('<?php echo ADMIN_ENC_URL;?>/adminlogin/change_admin_status/<?php echo $mode;?>/<?php echo $row->_id;?>');"><span class="badge_style b_done"><?php echo $row->status;?></span></a>
							<?php
							}
								}else {	
							?>
								<a href="javascript:confirm_status('<?php echo ADMIN_ENC_URL;?>/adminlogin/change_admin_status/<?php echo $mode;?>/<?php echo $row->_id;?>')"><span class="badge_style"><?php echo $row->status;?></span></a>
							<?php 
								}
							}else {
							?>
