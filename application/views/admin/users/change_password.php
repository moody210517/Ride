			...
			<div class="grid_12">
				<div class="widget_wrap">
					...
					<?php 
						...
						echo form_open_multipart(ADMIN_ENC_URL.'/users/change_password',$attributes);
					...
					?>
	 						<ul class="leftsec-contsec">
								...
								<div class="form_grid_12">
									<label class="field_title"><?php if ($this->lang->line('admin_user_email') != '') echo stripslashes($this->lang->line('admin_user_email')); else echo 'User Email'; ?> <span class="req">*</span></label>
									<div class="form_input">
										<input name="driver_email" id="driver_email" type="text"  class="required large tipTop"  value="<?php if(isset($user_details->email)) echo $user_details->email; ?>" disabled="disabled" />
									</div>
								</div>
								</li>
								...
								<li>
								<div class="form_grid_12">
									<label class="field_title"><?php if ($this->lang->line('admin_drivers_new_password') != '') echo stripslashes($this->lang->line('admin_drivers_new_password')); else echo 'Retype Password'; ?> <span class="req">*</span></label>
									<div class="form_input">
