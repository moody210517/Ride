	...
	<div class="grid_container">
     <div class="grid_12">
						...
						<div class="">
							<div class=" filter_wrap">
								<div class="widget_top filter_widget">
									...
									echo form_open(ADMIN_ENC_URL.'/referral/display_driver_referrals', $attributes)
									?>
										...
										<a href="<?php echo ADMIN_ENC_URL;?>/referral/display_driver_referrals"class="tipTop filterbtn" original-title="<?php if ($this->lang->line('driver_enter_view_all_users') != '') echo stripslashes($this->lang->line('driver_enter_view_all_users')); else echo 'View All Users'; ?>">
		...
		<?php 
			...
			echo form_open(ADMIN_ENC_URL.'/referral/change_driver_status_global',$attributes) 
		?>
			<div class="grid_12">
								...
								<tr>
									...
									<td class="center">
										<ul class="action_list">
											<li style="width:100%;">
												<a href="<?php echo ADMIN_ENC_URL;?>/referral/view_referral_details/<?php echo (string)$row->_id;?>?q=driver" class="p_edit tipTop" original-title="<?php if ($this->lang->line('admin_referral_history_view_details') != '') echo stripslashes($this->lang->line('admin_referral_history_view_details')); else echo 'View Details'; ?>">
