			...
			<div class="grid_12">
				<div class="widget_wrap">
					...
					<?php 
						...
						echo form_open(ADMIN_ENC_URL.'/location/insertCopyLocation',$attributes) 
					?> 			
