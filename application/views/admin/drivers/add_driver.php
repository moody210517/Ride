...
function custom_validate_form(){
	if($("#adddriver_form").valid()){
		...
		$.ajax({
			type:'post',
			url:'<?php echo ADMIN_ENC_URL;?>/drivers/check_driver_duplicate',
			data:{'email':uEmail,'dial_code':uCC,'phone_number':uPN,'driver_id':driver_id},
			dataType: 'json',
			success:function(res){
				$('#form_loader').css('display','none');
				if(res.status == '1'){ 
					$('#adddriver_form').submit();
				} else {
...
<div id="content" class="add-driver-base">
        ...
        <div class="grid_12">
            <div class="widget_wrap">
                ...
                <div class="widget_content">
                    <?php
                    $attributes = array('class' => 'form_container left_label', 'id' => 'adddriver_form', 'enctype' => 'multipart/form-data');
                    echo form_open_multipart(ADMIN_ENC_URL.'/drivers/insertEdit_driver', $attributes)
                    ?>
                    <ul class="left-drive-edit">

                        <li>
                            <div class="form_grid_12">
                                <h3 class="head_drive"><?php if ($this->lang->line('admin_drivers_drivers_location') != '') echo stripslashes($this->lang->line('admin_drivers_drivers_location')); else echo 'Driver Location'; ?></h3>
                            </div>
                        </li>
                        <li>
                            <div class="form_grid_12">
                                ...
                                <div class="form_input">
                                    <select name="driver_location" id="driver_location"  class="required chzn-select" style="height: 31px; width: 51%;">
                                     <option value="" hidden><?php if ($this->lang->line('select_driver_loc') != '') echo stripslashes($this->lang->line('select_driver_loc')); else echo 'Select driver location'; ?></option>
                                        <?php
                        ...
                        <li>
                            <div class="form_grid_12">
                                <h3 class="head_drive"><?php if ($this->lang->line('dash_driver_category') != '') echo stripslashes($this->lang->line('dash_driver_category')); else echo 'Driver Category'; ?></h3>
                            </div>
                        </li>
                        <li>
                            <div class="form_grid_12">
						...
						<li id="additional_cat_li_chk" style="display:none;">
                            <div class="form_grid_12">
							<input style="float: left; margin-top: -2px;" type="checkbox" name="multi_car_status" id="multi_car_status" value="ON" />
                                <label class="field_title" for="multi_car_status">Accept Rides From Additional Category ?</label>
						...
						<li id="additional_cat_li" style="display:none;">
                            <div class="form_grid_12">
                                <label style="margin-top:2%;" class="field_title" for="driver_name">Additional Category</label>
                                <div class="form_input">
                                    <select name="additional_category[]" id="additional_category" multiple="multiple" tabindex="1" class="chzn-select" style="height: 31px; width: 51%;">
                                        <option value="">Choose additional driver category</option>
                                    </select>
                                </div>
                            </div>
                        </li>
                        ...
                        <li>
                            <div class="form_grid_12">
                                <h3 class="head_drive"><?php if ($this->lang->line('admin_drivers_login_details') != '') echo stripslashes($this->lang->line('admin_drivers_login_details')); else echo 'Login Details'; ?></h3>
                            </div>
                        </li>
                        ...
                        <li>
                            <div class="form_grid_12">
                                <h3 class="head_drive"><?php if ($this->lang->line('admin_drivers_address_details') != '') echo stripslashes($this->lang->line('admin_drivers_address_details')); else echo 'Address Details'; ?></h3>
                            </div>
                        </li>
                        ...
                        <li>
                            <div class="form_grid_12">
                                ...
                                <div class="form_input">
                                    <textarea name="address" id="address"  class="required large tipTop" title="<?php if ($this->lang->line('driver_enter_driver_address') != '') echo stripslashes($this->lang->line('driver_enter_driver_address')); else echo 'Please enter the driver address'; ?>" style="width: 372px;"></textarea>
                                </div>
                            </div>
                        </li>
                            ...
                            <div class="form_grid_12">
                                ...
                                <div class="form_input">
                                    <select name="county" id="county"  class="required chzn-select" style="height: 31px; width: 51%;">
                                        ...
                                        <?php foreach ($countryList as $country) { if($d_country_cca3==$country->cca3)
											{?>
										
                                            <option value="<?php echo $country->name; ?>" data-dialCode="<?php echo $country->dial_code; ?>"selected='selected'><?php echo $country->name; ?></option> 
											<?php }else{ ?>
                        ...
                        <li>
                            <div class="form_grid_12">
                                <h3 class="head_drive"><?php if ($this->lang->line('admin_drivers_identity') != '') echo stripslashes($this->lang->line('admin_drivers_identity')); else echo 'Identity'; ?></h3>
                            </div>
                        </li>
					...
					<ul class="rite-drive-edit">
                        <input type="hidden" name="verify_status" value="No" />


                        <li>
                            <div class="form_grid_12">
                                <h3 class="head_drive"><?php if ($this->lang->line('admin_drivers_vehicle_information') != '') echo stripslashes($this->lang->line('admin_drivers_vehicle_information')); else echo 'Vehicle Information'; ?></h3>
                            </div>
                        </li>
                        ...
                        <?php if ($docx_list->num_rows() > 0 && $d_docx > 0) { ?>
                            ...
                            <li>
                                <div class="form_grid_12">
                                    <h3 class="head_drive"><?php if ($this->lang->line('admin_drivers_driver_documents') != '') echo stripslashes($this->lang->line('admin_drivers_driver_documents')); else echo 'Driver Documents'; ?></h3>
                                </div>
                            </li>
                        ...
                        <?php if ($docx_list->num_rows() > 0 && $v_docx > 0) { ?>
                            ...
                            <li>
                                <div class="form_grid_12">
                                    <h3 class="head_drive"><?php if ($this->lang->line('admin_drivers_vehicle_documents') != '') echo stripslashes($this->lang->line('admin_drivers_vehicle_documents')); else echo 'Vehicle Documents'; ?></h3>
                                </div>
                            </li>
...
var dash_please_choose_year_of_model =  "<?php if ($this->lang->line('dash_please_choose_year_of_model') != '') echo stripslashes($this->lang->line('dash_please_choose_year_of_model')); else echo 'Please choose year of model'; ?>";
    ...
    $(document).ready(function () {
        ...
        $("#category").change(function (e) {
			...
			if (cur_cat == "" || location_id == '') {
				...
				$.ajax({
				  type: "POST",
				  url: '<?php echo ADMIN_ENC_URL;?>/drivers/ajax_get_additional_category_list',
    ...
    $(document).ready(function () {
        ...
        $(".docx").change(function (e) {
            ...
            $.ajax({
                url: '<?php echo ADMIN_ENC_URL;?>/drivers/ajax_document_upload?docx_name=' + docxId,
                type: 'POST',
                xhr: function () {
