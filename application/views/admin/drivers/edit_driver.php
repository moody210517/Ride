                ...
                <div class="widget_content">
                    ...
                    <ul class="operator-sec-bar">
                                        ...
                                        if ($locationList->num_rows() > 0) {
                                            foreach ($locationList->result() as $loclist) {
												...
												if (isset($driver_details->driver_location)) {
													if ($driver_details->driver_location == (string)$loclist->_id) {
						...
						<li id="additional_cat_li_chk" style="display:<?php echo $adShow; ?>">
                            <div class="form_grid_12"> 
							<input type="checkbox" style="margin-top: -2px;" name="multi_car_status" id="multi_car_status" <?php if (isset($driver_details->multi_car_status)) if($driver_details->multi_car_status == 'ON') echo 'checked="checked"'; ?> value="ON" />
						...
						<li id="additional_cat_li" style="display:<?php echo $showChk; ?>">
                            <div class="form_grid_12">
                                <label style="margin-top: 2%;" class="field_title" for="additional_category"><?php if ($this->lang->line('admin_additional_category') != '') echo stripslashes($this->lang->line('admin_additional_category')); else echo 'Additional Categories'; ?></label>
                                <div class="form_input">
                            ...
                            <div class="form_grid_12">
                                ...
                                <div class="form_input">
									...
									<select name="dail_code" id="country_codeM"  class="required chzn-select small tipTop mCC" style="" title="<?php if ($this->lang->line('select_mobile_country_code') != '') echo stripslashes($this->lang->line('select_mobile_country_code')); else echo 'Please select mobile country code'; ?>">
										<?php foreach ($countryList as $country) { ?>
											<option value="<?php echo $country->dial_code; ?>" <?php if($country->dial_code==$driver_details->dail_code){ 
                                                if($country->cca3==$d_country_cca3){echo "selected='selected'"; }} ?>><?php echo $country->cca3.' ('.$country->dial_code.')'; ?></option>
										<?php } ?>
									</select>
                        ...
                        <li>
                            <div class="form_grid_12">
                                <label class="field_title"><?php if ($this->lang->line('admin_drivers_driver_commission_to_site') != '') echo stripslashes($this->lang->line('admin_drivers_driver_commission_to_site')); else echo 'Commission to Site'; ?><span class="req">*</span></label>
                                <div class="form_input">
                                    <input style="width: calc(100% - 35px)!important;margin-right:5px;float:left" name="driver_commission" id="driver_commission" type="text"  class="required large tipTop number positiveNumber currencyT" title="<?php if ($this->lang->line('admin_drivers_driver_commission_to_site_tooltip') != '') echo stripslashes($this->lang->line('admin_drivers_driver_commission_to_site_tooltip')); else echo 'Please enter the site commission for driver'; ?>" placeholder="<?php if ($this->lang->line('admin_ex') != '') echo stripslashes($this->lang->line('admin_ex')); else echo "EX."; ?> 14.00" value="<?php if (isset($driver_details->driver_commission)) echo $driver_details->driver_commission; ?>" />
