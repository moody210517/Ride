                            ...
                            <ul class="second-cms">
                                ...
                                <li>
                                    <div class="form_grid_12">
                                        ...
                                        <div class="form_input">
                                            <textarea name="description" id="description"  class="large tipTop mceEditor" title="<?php if ($this->lang->line('admin_pages_enter_page_content') != '') echo stripslashes($this->lang->line('admin_pages_enter_page_content')); else echo 'Please enter the page content'; ?>"></textarea>
                                        </div>
                                    </div>
                                </li>
								<?php /*
                            ...
                            <ul class="inner-subpage third-inner">
                                ...
                                <li>
                                    <div class="form_grid_12">
                                        ...
                                        <div class="form_input">
                                            <textarea name="meta_abstraction" id="meta_abstraction"  class="large tipTop" title="<?php if($this->lang->line('admin_pages_page_meta_abstraction') != '') echo stripslashes($this->lang->line('admin_pages_page_meta_abstraction')); else echo 'Please enter the meta Abstraction'; ?>"></textarea>
                                        </div>
                                    </div>
                                </li>
                            </ul>
...
<script>$('#addcms_form').validate();</script>
<?php
