...
<div id="content">
    <div class="grid_container">
        ...
        echo form_open(ADMIN_ENC_URL.'/cms/change_cms_status_global', $attributes)
        ?>
        <div class="grid_12">
										...
										*/ ?>
                                        <td class="center">
                                            ...
                                            if ($allPrev == '1' || in_array('2', $cms)) {
                                                ...
                                                if ($mode == '0') {
                                                    ?>
                                                    <a title="<?php if ($this->lang->line('admin_click_to_unpublish') != '') echo stripslashes($this->lang->line('admin_click_to_unpublish')); else echo 'Click to unpublish'; ?>" class="tip_top" href="javascript:confirm_status('<?php echo ADMIN_ENC_URL;?>/cms/change_cms_status/<?php echo $mode; ?>/<?php echo $row->_id; ?>');"><span class="badge_style b_done"><?php echo $disp_status; ?></span></a>
                                                    <?php
                                                } else {
                                                    ?>
                                                    <a title="<?php if ($this->lang->line('admin_click_to_publish') != '') echo stripslashes($this->lang->line('admin_click_to_publish')); else echo 'Click to publish'; ?>" class="tip_top" href="javascript:confirm_status('<?php echo ADMIN_ENC_URL;?>/cms/change_cms_status/<?php echo $mode; ?>/<?php echo $row->_id; ?>')"><span class="badge_style"><?php echo $disp_status; ?></span></a>
                                                    <?php
                                                }
                                            } else {
                                                ?>
