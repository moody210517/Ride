...
<div id="login_page reset-one">
	<div class="login_container reset-pass">
		...
		<div class="col-md-12 login-color reset_pass_new">
		<?php echo form_open(ADMIN_ENC_URL.'/adminlogin/reset_password');  ?>
