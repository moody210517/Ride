...
var x = setInterval(function() {
    ...
    if(days > 0){
        document.getElementById("pickup_timer").innerHTML = '<?php if ($this->lang->line('admin_trip_pickup_time') != '') echo stripslashes($this->lang->line('admin_trip_pickup_time')); else echo 'Trip pickup time expires in'; ?> ( <?php echo date('Y-m-d H:i:s',$pickupTime);?> ) :: <span style="color:orange;">  ' + days + " : " + hours + " : " + minutes + " : " + seconds+'</span>';
    } else {
			...
			<div class="grid_12">
				<div class="widget_wrap">
					<div class="widget_top">
                        ...
                        <?php if($pickupTime != '' && $rides_details->row()->ride_status == 'Booked' && $rides_details->row()->type != 'Now'){ ?>
                            <h6 id="pickup_timer"></h6>
                        <?php } ?>
					</div>
					...
					<div class="widget_content">
						...
						<tr>
							...
							<td class="center">
								...
								<?php if (isset($row['distance'])) echo number_format($row['distance'],2); ?> <?php echo $distance_unit; ?>
							</td>
							
							<td class="center">
								<ul class="action_list">
									<li style="width:100%;">
										<a class="p_car tipTop" href="<?php echo ADMIN_ENC_URL;?>/rides/assign_driver/<?php echo $rides_details->row()->ride_id;?>/<?php echo $row['_id'];?>" title="<?php if ($this->lang->line('admin_rides_assign_cab') != '') echo stripslashes($this->lang->line('admin_rides_assign_cab')); else echo 'Assign Cab'; ?>">
