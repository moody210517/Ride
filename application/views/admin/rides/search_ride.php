...
<div id="content" class="search-ride-base">
        ...
        <div class="grid_12">
            <div class="widget_wrap">
				...
				<div class="widget_content">
					<?php
					$attributes = array('class' => 'form_container left_label', 'id' => 'admin_search_ride_form','method'=>'GET','autocomplete'=>'off','enctype' => 'multipart/form-data');
					echo form_open(ADMIN_ENC_URL.'/rides/search_ride', $attributes)
					?>
                        <div>
                        <ul class="ride-search-inner">
						<li>
					...
					?>
                        <div>
                        <ul class="ride-search-inner" style="margin-top:15px">
						...
						<div class="form_grid_12">
							...
							<div class="form_input">
								...
								if(in_array($ride_status,$completeArr)){  ?>
									<a class="btn_small btn_blue" style="background:#0f78b9   none repeat scroll 0 0 !important;" href="<?php echo ADMIN_ENC_URL;?>/rides/end_ride_form?ride_id=<?php echo $ride_details->row()->ride_id; ?>" title="<?php if ($this->lang->line('admin_end_ride') != '') echo stripslashes($this->lang->line('admin_end_ride')); else echo 'End Ride'; ?>">
									<span class="icon delete_co"></span>
