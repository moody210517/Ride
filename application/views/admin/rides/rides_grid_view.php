...
<p class="back-options">
	<a href="<?php echo base_url().ADMIN_ENC_URL; ?>" style="background-color:#00c0ef ;"><?php if ($this->lang->line('admin_back_to_admin') != '') echo stripslashes($this->lang->line('admin_back_to_admin')); else echo 'Back to Admin Panel'; ?></a>
</p>
    <div id="col1">
        <table width="100%">
			<thead>
    ...
    <script>
		...
		setInterval(function(){
			$.ajax({
				type: "POST",
				url: '<?php echo base_url().ADMIN_ENC_URL; ?>/rides/get_rides_ajax',
