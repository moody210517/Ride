     ...
     <div class="admin-login-inner-wrap">
			...
			<?php if (validation_errors() != ''){?>
						...
						<div class="admin-login-form">
                                ...
                                echo form_open(OPERATOR_NAME.'/settings/forgot_password',$dataArr); ?>
