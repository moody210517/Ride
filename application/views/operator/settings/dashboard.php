...
<h6><?php if ($this->lang->line('admin_dashboard_ride_statistics') != '') echo stripslashes($this->lang->line('admin_dashboard_ride_statistics')); else echo 'Ride Statistics'; ?></h6>						
                            <div class="activities_s site_statistics">
                                <div class="block_label">  
									...
									<a href="<?php echo OPERATOR_NAME;?>/trip/display_trips?act=total" class="small-box-footer"><?php if ($this->lang->line('panel_more_info') != '') echo stripslashes($this->lang->line('panel_more_info')); else echo 'More info'; ?> <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
							<div class="activities_s site_statistics">
                                <div class="block_label">
                                    ...
                                    <i class="user_icon_font fa fa-car"></i>
									<a href="<?php echo OPERATOR_NAME; ?>/trip/display_trips?act=Booked" class="small-box-footer"><?php if ($this->lang->line('panel_more_info') != '') echo stripslashes($this->lang->line('panel_more_info')); else echo 'More info'; ?> <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                           <div class="activities_s site_statistics">
                                <div class="block_label">
                                    ...
                                    <i class="user_icon_font fa fa-car"></i>
									<a href="<?php echo OPERATOR_NAME; ?>/trip/display_trips?act=Completed" class="small-box-footer"><?php if ($this->lang->line('panel_more_info') != '') echo stripslashes($this->lang->line('panel_more_info')); else echo 'More info'; ?> <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            ...
                            <div class="activities_s site_statistics">
                                <div class="block_label">
                                    ...
                                    <i class="user_icon_font fa fa-car"></i>
									<a href="<?php echo OPERATOR_NAME; ?>/trip/display_trips?act=OnRide" class="small-box-footer"><?php if ($this->lang->line('panel_more_info') != '') echo stripslashes($this->lang->line('panel_more_info')); else echo 'More info'; ?> <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            ...
                            <div class="activities_s site_statistics">
                                <div class="block_label">
                                    ...
                                    <i class="user_icon_font fa fa-car"></i>
									<a href="<?php echo OPERATOR_NAME; ?>/trip/display_trips?act=riderCancelled" class="small-box-footer"><?php if ($this->lang->line('panel_more_info') != '') echo stripslashes($this->lang->line('panel_more_info')); else echo 'More info'; ?> <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            ...
                            <div class="activities_s site_statistics">
                                <div class="block_label">
                                    ...
                                    <i class="user_icon_font fa fa-car"></i>
									<a href="<?php echo OPERATOR_NAME; ?>/trip/display_trips?act=driverCancelled" class="small-box-footer"><?php if ($this->lang->line('panel_more_info') != '') echo stripslashes($this->lang->line('panel_more_info')); else echo 'More info'; ?> <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
