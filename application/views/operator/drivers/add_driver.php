            ...
            <div class="widget_wrap">
                ...
                <div class="widget_content">
                    ...
                    <ul class="left-contsec operator_drive_sec">
						...
						<li id="additional_cat_li_chk" style="display:none;">
                            <div class="form_grid_12">
								<input type="checkbox" style="float: left;" name="multi_car_status" id="multi_car_status" value="ON" />
						...
						<li id="additional_cat_li" style="display:none;">
                            <div class="form_grid_12">
                                <label class="field_title" for="driver_name">Additional Category</label>
                                <div class="form_input">
