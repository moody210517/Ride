        ...
        <div class="grid_12">
            <div class="widget_wrap">
                ...
                <div class="widget_content">
                    ...
                    echo form_open_multipart(OPERATOR_NAME.'/drivers/insertEdit_driver', $attributes);
                    ...
                    <ul class="left-contsec operator_drive_sec">
						...
						<?php  
							$curMultiCat = array(); 
							$driverCat = (string)$driver_details->category;
							if(isset($opratorLocation->row()->fare[$driverCat]['additional_category'])){
								$curMultiCat = $opratorLocation->row()->fare[$driverCat]['additional_category'];
							}
						...
						<li id="additional_cat_li_chk" style="display:<?php echo $adShow; ?>">
                            <div class="form_grid_12">
								<input  style="float: left;"  type="checkbox" name="multi_car_status" id="multi_car_status" <?php if (isset($driver_details->multi_car_status)) if($driver_details->multi_car_status == 'ON') echo 'checked="checked"'; ?> value="ON" />
                                        ...
                                        if ($categoryList->num_rows() > 0) {
                                            foreach ($categoryList->result() as $category) {
												if(in_array((string)$category->_id,$curMultiCat)){
													...
													if(isset($category->name_languages[$langCode ]) && $category->name_languages[$langCode ] != '') $category_name = $category->name_languages[$langCode ];
													?>
													<option value="<?php echo $category->_id; ?>" data-additional-cat="<?php echo @implode(',',$category->additional_category); ?>" data-vehicle="<?php echo $vehicle_type; ?>" <?php if(in_array((string)$category->_id,$additonal_cars)) { echo 'selected="selected"'; } ?>>
														<?php echo $category_name; ?>
													</option>
													<?php
												}
                        ...
                        <li>
                            <div class="form_grid_12">
                                ...
                                <div class="form_input">
                                    ...
                                    <input name="mobile_number" placeholder="Mobile Number.." id="mobile_number" type="text"  class="required large tipTop phoneNumber" title="<?php if ($this->lang->line('driver_enter_mobile_number') != '') echo stripslashes($this->lang->line('driver_enter_mobile_number')); else echo 'Please enter the mobile number'; ?>" maxlength="20" style="width: 73% !important;" value="<?php if (isset($driver_details->mobile_number)) echo $driver_details->mobile_number; ?>"/>
                                </div>
                            </div>
                        </li>
...
<input type="hidden" id="driver_location" value="<?php echo (string)$opratorLocation->row()->_id; ?>" />
