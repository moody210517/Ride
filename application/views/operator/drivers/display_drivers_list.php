...
$(document).ready(function(){
    $("#export_report").click(function(event){  
		...
		window.location.href = "<?php echo OPERATOR_NAME;?>/drivers/display_drivers_list?" + query_strings + "&export=excel";
	});
    
    $("#export_report_all").click(function(event){
		event.preventDefault();
		var query_strings = "<?php echo $_SERVER["QUERY_STRING"]; ?>";
		window.location.href = "<?php echo OPERATOR_NAME;?>/drivers/display_drivers_list?" + query_strings + "&export=all";
	});
						...
						<div class="">
							<div class=" filter_wrap">
								<div class="widget_top filter_widget display_filter_wp">
									...
									echo form_open(OPERATOR_NAME.'/drivers/display_drivers_list', $attributes)
									?>
                                    ...
                                    <tr style="border-bottom: 1px solid #dddddd !important;">
                                        ...
                                        <td class="center" style="20px;">
                                            <?php if (isset($row->avg_review)) { ?>
                                                <?php if ($row->avg_review != '') { ?>
                                                    <a href="<?php echo OPERATOR_NAME;?>/reviews/view_driver_reviews/<?php echo $row->_id; ?>" style="color:blue;" ><?php echo number_format($row->avg_review, 2) . ' (' . $row->total_review . ')'; ?></a>
                                                <?php } else { ?>
                                                    0 (0)
                                                    <?php
                                                }
                                        ...
                                        <td class="center">
											...
											if (isset($row->mode)) {
													...
													$mode = '0';
												?>
												   <a title="<?php if ($this->lang->line('common_click_to_make_available') != '') echo stripslashes($this->lang->line('common_click_to_make_available')); else echo 'Click to make available'; ?>" class="tip_top" href="javascript:confirm_status('<?php echo OPERATOR_NAME;?>/drivers/change_driver_mode_status/<?php echo $mode; ?>/<?php echo $row->_id; ?>');">
                                        ...
                                        <td class="center">
                                            ...
                                            <span class="badge_style <?php if($mode==0)  { ?> b_done <?php } ?>"><?php echo $verify_status; ?></span>
                                        ...
                                        <td class="center">
                                           ...
                                           ?>
                                            <span class="badge_style  <?php if($mode==0)  { ?> b_done <?php } ?>"><?php echo $disp_status; ?></span>
                                        ...
                                        <td class="center action-icons-wrap">
                                            ...
                                            <?php if ($allPrev == '1' || in_array('2', $driver) || $driver == null) { ?>
                                                <span><a class="action-icons c-bank" href="<?php echo OPERATOR_NAME;?>/drivers/banking/<?php echo $row->_id; ?>" title="<?php if ($this->lang->line('driver_connect_banking') != '') echo stripslashes($this->lang->line('driver_connect_banking')); else echo 'Connect Banking'; ?>"><?php if ($this->lang->line('driver_connect_banking') != '') echo stripslashes($this->lang->line('driver_connect_banking')); else echo 'Connect Banking'; ?></a></span>
                                            ...
                                            <?php if ($allPrev == '1' || in_array('3', $driver) || $driver == null) { ?>	
                                                <?php if ($row->status != 'Deleted') { ?>
                                                    <span><a class="action-icons c-delete" href="javascript:confirm_delete('<?php echo OPERATOR_NAME;?>/drivers/delete_driver/<?php echo $row->_id; ?>')" title="<?php if ($this->lang->line('admin_common_delete') != '') echo stripslashes($this->lang->line('admin_common_delete')); else echo 'Delete'; ?>"></a></span>
                                                <?php } ?>
                                            <?php } ?>
                                        </td>
