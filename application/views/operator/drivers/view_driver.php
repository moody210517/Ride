								...
								<li>
									<div class="form_grid_12">
										...
										<div class="form_input expiry_box">
											...
											<?php } else { ?>
												<a><?php echo $vehicles_doc['typeName'] ?> <?php echo $not_available; ?></a>
											<?php } 
												}
											?>
							...
							<div id="tab4">
								<ul class="leftsec-contsec">
									...
									<li>
										<div class="form_grid_12">
											<label class="field_title"></label>
											<div style="    text-align: center;" class="form_input">
												<p style="    text-align: left;"><?php if ($this->lang->line('admin_drivers_no_record_found') != '') echo stripslashes($this->lang->line('admin_drivers_no_record_found')); else echo 'No records found'; ?></p>
												<a style="width:initial!important;" href="<?php echo OPERATOR_NAME; ?>/drivers/banking/<?php echo $driver_details->_id; ?>" class="expiry_box banking-btn"><?php if ($this->lang->line('admin_drivers_connect_banking') != '') echo stripslashes($this->lang->line('admin_drivers_connect_banking')); else echo 'Connect Banking'; ?></a>
											</div>
										</div>
									</li>
									<?php 
