...
$("#cancelled_by").change(function(){
	...
	$.ajax({
      ...
      url: '<?php echo OPERATOR_NAME; ?>/trip/user_type_cancellation_reason',
      dataType: "json",
        ...
        <div class="grid_12">
            <div class="widget_wrap">
                ...
                <div class="widget_content">
                    <form class="form_container left_label" action="<?php echo OPERATOR_NAME; ?>/trip/cancelling_ride" id="admin_cancelling_ride_form" method="post" enctype="multipart/form-data">
                        <div>
                        <ul>
						...
						<label class="field_title"><?php if ($this->lang->line('admin_rides_cancellation_reason') != '') echo stripslashes($this->lang->line('admin_rides_cancellation_reason')); else echo 'Cancelling Reason'; ?> <span class="req">*</span></label>
							<div class="form_input model_type">
								<select id="cancel_reason" class="chzn-select admin_cancel_ride_chosen required" name="reason"  style="width: 375px; display: none;" >
