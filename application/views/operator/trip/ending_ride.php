        ...
        <div class="grid_12">
            <div class="widget_wrap">
                ...
                <div class="widget_content">
                    <form class="form_container left_label" action="<?php echo OPERATOR_NAME; ?>/trip/ending_ride" id="admin_cancelling_ride_form" method="post" enctype="multipart/form-data">
                        <div>
                        <ul>
							...
							<li>
								...
								<label class="field_title"><?php if ($this->lang->line('admin_drop_time') != '') echo stripslashes($this->lang->line('admin_drop_time')); else echo 'Drop Time'; ?> <span class="req">*</span></label>
									<div class="form_input">
										<input name="drop_time" id="drop_time" readonly="readonly" placeholder="" type="text"  class="large tipTop required datepicker_sd" title="<?php if ($this->lang->line('admin_enter_drop_time') != '') echo stripslashes($this->lang->line('admin_enter_drop_time')); else echo 'Enter the drop time'; ?>" />
									</div>
								</div>
							</li>
