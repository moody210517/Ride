			...
			<div class="grid_12">
				<div class="widget_wrap">
					...
					<?php
						...
						echo form_open(OPERATOR_NAME.'/rides/display_rides_list',$attributes) 
					?> 		
               ...
               ?>
						...
						<ul class="drop_locate_details drop_2 left-contsec booking">
							...
							<li class="change-pass">
									<div class="form_grid_12">
										<div class="form_input">
											<a class="tipLeft" href="<?php  if(isset($_SERVER['HTTP_REFERER'])) echo $_SERVER['HTTP_REFERER']; else echo OPERATOR_NAME.'/trip/display_rides';?>" original-title="<?php if ($this->lang->line('dash_go_rides_list') != '') echo stripslashes($this->lang->line('dash_go_rides_list')); else echo 'Go to rides list'; ?>">
