...
<div id="content">
		<div class="grid_container">
			<?php 
				...
				echo form_open(OPERATOR_NAME.'/brand/change_model_status_global',$attributes) 
			?>
			<div class="grid_12">
