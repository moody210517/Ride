...
<div id="content">
		<div class="grid_container">
			<?php 
				...
				echo form_open(OPERATOR_NAME.'/brand/change_brand_status_global',$attributes) 
			?>
			<div class="grid_12">
					...
					<div class="widget_top">
						...
						<div style="float: right;line-height:40px;padding:0px 10px;height:39px;">
							...
							<div class="btn_30_light" style="height: 29px; text-align:left;">
								<a href="<?php echo OPERATOR_NAME;?>/brand/add_brand_form" class="tipTop" title="<?php if ($this->lang->line('make_model_add_new_brand') != '') echo stripslashes($this->lang->line('make_model_add_new_brand')); else echo 'Click here to Add New Brand'; ?>"><!-- <span class="icon add_co"></span> --><span class="btn_link act-btn"><?php if ($this->lang->line('admin_car_add_new') != '') echo stripslashes($this->lang->line('admin_car_add_new')); else echo 'Add New'; ?></span></a>
							</div>
