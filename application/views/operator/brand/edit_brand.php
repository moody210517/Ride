        ...
        <div class="grid_12">
            <div class="widget_wrap">
                ...
                <div class="widget_content chenge-pass-base">
                    ...
                    echo form_open_multipart(OPERATOR_NAME.'/brand/EditBrand', $attributes)
                    ?>
                    <div>
                            ...
                            <li>
                                <div class="form_grid_12">
                                    ...
                                    <div class="form_input">
                                        <input name="brand_name" id="brand_name" type="text"  class="required large tipTop" title="<?php if ($this->lang->line('make_model_enter_brandname') != '') echo stripslashes($this->lang->line('make_model_enter_brandname')); else echo 'Please enter the brandname'; ?>" value="<?php echo $brand_details->row()->brand_name; ?>"/>
                                    </div>
                                </div>
                            </li>
    ...
    $(document).ready(function () {
        $("#brand_logo").change(function (e) {
            ...
            $.ajax({
                ...
                url: '<?php echo OPERATOR_NAME; ?>/brand/ajax_check_brand_logo',
                type: 'POST',
                xhr: function () {
