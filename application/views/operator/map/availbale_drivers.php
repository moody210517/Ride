...
<span><?php if (isset($onride_drivers)) echo $onride_drivers; ?></span>														
		...
		<div class="widget_content">
							...
							echo form_open(OPERATOR_NAME.'/map/map_avail_drivers', $attributes)
							?>
								<div class="grid_12">
								...
								<button type="button" onclick="find();" class="btn" id="btn_find" ><?php if ($this->lang->line('admin_map_find') != '') echo stripslashes($this->lang->line('admin_map_find')); else echo 'Find'; ?></button>
								<?php $location=$this->input->get('location');if((isset($city)&&$city!='')||(isset($radius)&&$radius!='')||(isset($location)&&$location!='')){ ?>
								<a href= "<?php echo OPERATOR_NAME ?>/map/map_avail_drivers" class="btn"  id="btn_find" original-title="<?php if ($this->lang->line('admin_notification_remove_filter') != '') echo stripslashes($this->lang->line('admin_notification_remove_filter')); else echo 'Remove Filter'; ?>">
						...
						<table class="display display_tbl" id="area_zone_tbl">
							...
							<tbody>
								...
								<tr>
                                    ...
                                    <td class="center">
										<a href="<?php echo base_url().OPERATOR_NAME; ?>/map/map_online_driver/<?php echo (string)$row['_id']; ?>" target="_blank">Track Map</a>
									</td>
...
function moveToLocation(lat, lng){
	//var center = new google.maps.LatLng(lat, lng);	
	 var locationRio = {lat: parseFloat(lat), lng: parseFloat(lng)};
