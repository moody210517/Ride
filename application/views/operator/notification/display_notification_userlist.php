...
<div id="content" >
    <div class="grid_container">
						...
						<div class="">
							<div class=" filter_wrap">
								<div class="widget_top filter_widget">
									...
									<form method="GET" id="filter_form" action="<?php echo OPERATOR_NAME; ?>/notification/display_notification_user_list" accept-charset="UTF-8">	
										...
										<a href="<?php echo OPERATOR_NAME; ?>/notification/display_notification_user_list"class="tipTop filterbtn" original-title="View All Users">
        ...
        <div class="grid_12">
            <div class="widget_wrap">
                ...
                <div class="widget_content">
                    ...
                    if ($paginationLink != '') {
                        echo $paginationLink;
                        $tble = 'operator_userlist';
                    } else {
                        $tble = 'operatoruser_listTbl';
                    }
                    ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="center">
                                           ...
                                           <?php if (isset($row->avg_review)) { ?>
                                                <a href="<?php echo OPERATOR_NAME; ?>/drivers/view_user_reviews/<?php echo $row->_id; ?>" title="<?php if ($this->lang->line('user_view_review_details') != '') echo stripslashes($this->lang->line('user_view_review_details')); else echo 'View review details'; ?>" class="tip_top"style="color:blue;"><?php echo $row->avg_review; ?> (<?php echo $row->total_review; ?>) </a>
                                            <?php } else { ?>
                                                <a> 0 (0) </a>
                                            <?php } ?>
        ...
        <div id="send_notification" style="display:none;">
            ...
            echo form_open_multipart(OPERATOR_NAME . '/notification/send_notification_to_device', $attributes);
            ?>
            <ul>
