...
<div id="content">
    <div class="grid_container">
						...
						<div class="">
							<div class=" filter_wrap">
								<div class="widget_top filter_widget">
									...
									<form method="GET" id="filter_form" action="<?php echo OPERATOR_NAME; ?>/notification/display_notification_driver_list" accept-charset="UTF-8">	
										...
										<a href="<?php echo OPERATOR_NAME; ?>/notification/display_notification_driver_list"class="tipTop filterbtn" original-title="<?php if ($this->lang->line('driver_enter_view_all_users') != '') echo stripslashes($this->lang->line('driver_enter_view_all_users')); else echo 'View All Users'; ?>">
        ...
        <div class="grid_12">
            <div class="widget_wrap">
                    ...
                    <div style="float: right;line-height:40px;padding:0px 10px;height:39px;">
						...
						<div class="btn_30_light" style="height: 29px;">
                            <a class="o-modal tipTop" data-content="send_sms"  href="javascript:void(0)" original-title="<?php if ($this->lang->line('admin_notification_send_notify_sms_tooltip') != '') echo stripslashes($this->lang->line('admin_notification_send_notify_sms_tooltip')); else echo 'Select any checkbox and click here to send SMS'; ?>">
                                ...
                                <span  class="btn_link"><?php if ($this->lang->line('please_send_sms') != '') echo stripslashes($this->lang->line('please_send_sms')); else echo 'Send SMS'; ?></span>
                            </a>
                        </div>
                        ...
                        <div class="btn_30_light" style="height: 29px;">
                            <a class="o-modal tipTop" data-content="send_notification"  href="javascript:void(0)" original-title="<?php if ($this->lang->line('admin_notification_send_notify_tooltip') != '') echo stripslashes($this->lang->line('admin_notification_send_notify_tooltip')); else echo 'Select any checkbox and click here to send Notification'; ?>">
                                <!-- <span class="icon accept_co"></span> -->
                                <span  class="btn_link"><?php if ($this->lang->line('admin_notification_send_notification') != '') echo stripslashes($this->lang->line('admin_notification_send_notification')); else echo 'Send Notification'; ?></span>
                            </a>
						...
						<div class="btn_30_light" style="height: 29px;">
                            <a class="o-modal tipTop" data-content="send_emails"  href="javascript:void(0)"  original-title="<?php if ($this->lang->line('admin_notification_send_notify_email_tooltip') != '') echo stripslashes($this->lang->line('admin_notification_send_notify_email_tooltip')); else echo 'Select any checkbox and click here to send Email'; ?>">
                                <!-- <span class="icon accept_co"></span> -->
                                <span  class="btn_link"><?php if ($this->lang->line('admin_notification_send_email') != '') echo stripslashes($this->lang->line('admin_notification_send_email')); else echo 'Send Email'; ?></span>
                            </a>
                ...
                <div class="widget_content">
                    ...
                    if ($paginationLink != '') {
                        echo $paginationLink;
                        $tble = 'operatorNotification_tbl';
                    } else {
                        $tble = 'operatorNoti_tbl';
                    }
                    ?>
                                        ...
                                        <td class="center">
                                           ...
                                           <?php if (isset($row->avg_review)) { ?>
                                                <?php if ($row->avg_review != '') { ?>
                                                    <a href="<?php echo OPERATOR_NAME; ?>/drivers/view_driver_reviews/<?php echo $row->_id; ?>" style="color:blue;" ><?php echo number_format($row->avg_review, 2) . ' (' . $row->total_review . ')'; ?></a>
                                                <?php } else { ?>
                                                    0 (0)
                                                    <?php
                                                }
        ...
        <div id="send_notification" style="display:none;">
            ...
            echo form_open_multipart(OPERATOR_NAME.'/notification/send_notification_to_device_driver', $attributes);
            ?>
            <ul>
                ...
                <li>
                    ...
                    <div class="form_grid_12">
                        ...
                        <div class="form_input">
                          <select id="sel_notification" onchange="sendNotifi();" class="chzn-select1 required" name="notification_id"  style="width: 320px; display: none;" data-placeholder="Select Model Type">
		...
		<div id="send_emails" style="display:none;">
            ...
            echo form_open_multipart(OPERATOR_NAME.'/notification/send_email_to_users', $attributes);
            ?>
            <ul>
                 ...
                 <li>
                    ...
                    <div class="form_grid_12">
                        ...
                        <div class="form_input">
                          <select id="sel_email" onchange="sendEmail();" class="chzn-select1 required" name="email_id"  style="width: 320px; display: none;" data-placeholder="Select Model Type">
...
<div id="send_sms" style="display:none;">
	...
	echo form_open_multipart(OPERATOR_NAME.'/notification/send_sms_to_device', $attributes);
	?>
	<ul>
		...
		<input name="user_type" type="hidden"   value="driver"/>
			<div class="form_grid_12">
				...
				<div class="form_input">
				<select id="send_smsDrop"  class="chzn-select1 required" onchange="sendSMS();" name="sms_id"  style="width: 320px;" data-placeholder="Select Model Type">
