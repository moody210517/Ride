			...
			<div class="shipping_address">
				<div class="main">
					<div class="app-content-box ">
						...
						<h1><?php if ($this->lang->line('stripe_complete_booking') != '') echo stripslashes($this->lang->line('stripe_complete_booking')); else echo 'Complete Booking'; ?> <a class="close_btn" href="<?php echo base_url(); ?>v8/mobile/payment/Cancel?mobileId=<?php echo $mobileId; ?>"></a></h1>
						<div class="col-md-11 pay-instructions">
							...
							<form action="<?php echo base_url(); ?>v8/mobile/stripe-manual-payment-process" name="wallet_recharge_form" id="wallet_recharge_form" method="POST" onsubmit="return showLoader();">
								<?php 
