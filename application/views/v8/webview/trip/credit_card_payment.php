			...
			<div class="shipping_address">
				<div class="main">		
					<div class="app-content-box">
						<h1><?php if ($this->lang->line('stripe_payment_enter_card_information') != '') echo stripslashes($this->lang->line('stripe_payment_enter_card_information')); else echo 'Enter Credit Card Informations'; ?><a class="close_btn" href="<?php echo base_url(); ?>v8/mobile/payment/Cancel?mobileId=<?php echo $mobileId; ?>"></a></h1>
						<form name="PaymentCard" id="PaymentCard" method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>v8/api_v7/payment/userPaymentCard">
						<ul>
							<li>
