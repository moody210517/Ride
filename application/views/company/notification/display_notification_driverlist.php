...
<div id="content">
    <div class="grid_container">
						...
						<div class="">
							<div class=" filter_wrap">
								<div class="widget_top filter_widget">
									...
									<form method="GET" id="filter_form" action="<?php 
									echo COMPANY_NAME; ?>/notification/display_notification_driver_list" accept-charset="UTF-8">	
										...
										<a href="<?php echo COMPANY_NAME; ?>/notification/display_notification_driver_list"class="tipTop filterbtn" original-title="<?php if ($this->lang->line('admin_notification_remove_filter') != '') echo stripslashes($this->lang->line('admin_notification_remove_filter')); else echo 'Remove Filter'; ?>">
											<span class="icon delete_co"></span><span class="btn_link"></span>
										</a>
										<?php } ?>
										</form>
        ...
        echo form_open(COMPANY_NAME.'/users/change_user_status_global', $attributes)
        ?>
        <div class="grid_12">
            <div class="widget_wrap">
                ...
                <div class="widget_content">
                    ...
                    if ($paginationLink != '') {
                        echo $paginationLink;
                        $tble = 'company_drivernotification';
                    } else {
                        $tble = 'company_notifcation';
                    }
                    ?>
                                        ...
                                        <td class="center">
                                             ...
                                             <?php if (isset($row->avg_review)) { ?>
                                                <?php if ($row->avg_review != '') { ?>
                                                    <a href="<?php echo COMPANY_NAME; ?>/drivers/view_driver_reviews/<?php echo $row->_id; ?>" style="color:blue;" ><?php echo number_format($row->avg_review, 2) . ' (' . $row->total_review . ')'; ?></a>
                                                <?php } else { ?>
                                                    0 (0)
                                                    <?php
                                                }
        ...
        <div id="send_notification" style="display:none;">
            ...
            echo form_open_multipart(COMPANY_NAME.'/notification/send_notification_to_device_driver', $attributes);
            ?>
            <ul>
		...
		<div id="send_emails" style="display:none;">
            ...
            echo form_open_multipart(COMPANY_NAME.'/notification/send_email_to_users', $attributes);
            ?>
            <ul>
...
<div id="send_sms" style="display:none;">
	...
	echo form_open_multipart(COMPANY_NAME.'/notification/send_sms_to_device', $attributes);
	?>
	<ul>
