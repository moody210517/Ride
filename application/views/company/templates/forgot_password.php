...
<div class="admin-login-wrap">
   <div class="admin-login-outer-wrap">
     <div class="admin-login-inner-wrap">
        ...
        echo form_open(COMPANY_NAME.'/login/forgot_password',$dataArr) ?>
				...
				<!--<h3 class=""><?php if ($this->lang->line('admin_login_forgot_password') != '') echo stripslashes($this->lang->line('admin_login_forgot_password')); else echo 'Forgot Password'; ?></h3>-->
					...
					<input name="email" class="required" type="text" value="" placeholder="<?php if ($this->lang->line('admin_email_id') != '') echo stripslashes($this->lang->line('admin_email_id')); else echo 'Email Id'; ?>">
					</div>
