...
<?php } ?>
		...
		<?php echo form_open(COMPANY_NAME.'/login/user_login');  ?>
			<div class="login_form">
				...
				<ul>
					...
					<input name="admin_name" value="" type="text" placeholder="<?php if ($this->lang->line('admin_users_users_list_email') != '') echo stripslashes($this->lang->line('admin_users_users_list_email')); else echo 'Email'; ?>" >
					</li>
			...
			<ul class="login_opt_link" style="float:left">
				<li style=" margin: 6px 0 0;"><a href="<?php echo COMPANY_NAME; ?>/login/forgot_password_form" class="tipLeft"><?php if ($this->lang->line('admin_login_forgot_password') != '') echo stripslashes($this->lang->line('admin_login_forgot_password')); else echo 'Forgot Password'; ?>?</a></li>
