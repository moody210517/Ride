...
<body id="theme-default" class="full_block" style="position:relative">
<?php  $this->load->view(COMPANY_NAME.'/templates/sidebar.php'); ?>
<?php
				...
				<ul>
					...
					<li class="user_info">
						<span class="user_name">
							<!--<?php echo $this->session->userdata(APP_NAME.'_session_company_name'); ?>-->
