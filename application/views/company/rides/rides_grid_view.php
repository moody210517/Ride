...
<p class="back-options">
	<a href="<?php echo base_url().COMPANY_NAME; ?>" style="background-color:#00c0ef ;"><?php if ($this->lang->line('admin_back_to_company') != '') echo stripslashes($this->lang->line('admin_back_to_company')); else echo 'Back to Company Panel'; ?></a>
</p>
    <div id="col1">
        <table width="100%">
			<thead>
    ...
    <script>
		...
		setInterval(function(){
			$.ajax({
				type: "POST",
				url: '<?php echo base_url().COMPANY_NAME; ?>/rides/get_rides_ajax',
