...
<script>
	...
	$(function (){
		$("#export_mileage").click(function(event){
			...
			get_field_values();
			window.location.href = "<?php echo base_url(); ?><?php echo COMPANY_NAME; ?>/mileage/export_mileage_report?type="+$type+'&vehicle_category='+$vehicle_category+'&date_range='+$date_range+'&dateto='+$dateto+'&filtervalue='+$value;
		});
	});
						...
						<div class="">
							<div class=" filter_wrap">
								<div class="widget_top filter_widget">
									...
									<form method="get" id="filter_form" action="<?php echo COMPANY_NAME; ?>/mileage/display_mileage_list" accept-charset="UTF-8">
										...
										<select name="vehicle_category" class='vehicle_category' style="display:none">
											<option value="" hidden="hidden">Choose Car Type</option>
										<?php 
											$veh_cat = '';
										...
										<a href="<?php echo COMPANY_NAME; ?>/mileage/display_mileage_list" class="tipTop filterbtn" original-title="<?php if ($this->lang->line('driver_enter_remove_filter') != '') echo stripslashes($this->lang->line('driver_enter_remove_filter')); else echo 'Remove Filter'; ?>">
                               ...
                               <th class="tip_top" title="<?php if ($this->lang->line('dash_click_sort') != '') echo stripslashes($this->lang->line('dash_click_sort')); else echo 'Click to sort'; ?>">
                                ...
                                <th class="tip_top" title="<?php if ($this->lang->line('dash_click_sort') != '') echo stripslashes($this->lang->line('dash_click_sort')); else echo 'Click to sort'; ?>">
                                 <!--Free Roaming Duration--> 
											<?php if ($this->lang->line('admin_drivers_mileage_free_roaming_duration') != '') echo stripslashes($this->lang->line('admin_drivers_mileage_free_roaming_duration')); else echo 'Free Roaming Duration'; ?>  
                                </th>
                                <th>
											<!-- Pickup Distance-->
                                ...
                                <th class="tip_top" title="<?php if ($this->lang->line('dash_click_sort') != '') echo stripslashes($this->lang->line('dash_click_sort')); else echo 'Click to sort'; ?>">
                                 <!--Pickup Duration-->
											<?php if ($this->lang->line('admin_drivers_mileage_pickup_duration') != '') echo stripslashes($this->lang->line('admin_drivers_mileage_pickup_duration')); else echo 'Approaching Duration'; ?> 											
                                </th>
                                <th class="tip_top" title="<?php if ($this->lang->line('dash_click_sort') != '') echo stripslashes($this->lang->line('dash_click_sort')); else echo 'Click to sort'; ?>">
                                ...
                                <th class="tip_top" title="<?php if ($this->lang->line('dash_click_sort') != '') echo stripslashes($this->lang->line('dash_click_sort')); else echo 'Click to sort'; ?>">
                                 <!--Trip Duration -->
											<?php if ($this->lang->line('admin_drivers_mileage_trip_duration') != '') echo stripslashes($this->lang->line('admin_drivers_mileage_trip_duration')); else echo 'Trip Duration'; ?> 											
                                ...
                                foreach ($mileage_data as $key=>$row) {
                                    ...
                                    <tr style="border-bottom: 1px solid #dddddd !important;">
                                        ...
                                        <td class="center" style="width:140px;">
											...
											?>
                                            <span><a class="action-icons c-suspend" href="company/mileage/view_driver_mileage/<?php echo $key; ?><?php echo $urlVal; ?>" title="<?php if ($this->lang->line('admin_common_view') != '') echo stripslashes($this->lang->line('admin_common_view')); else echo 'View'; ?>"></a></span>
