...
<script>
	...
	$(function (){
		$("#export_mileage").click(function(event){
			...
			get_field_values();
			window.location.href = "<?php echo base_url(); ?><?php echo COMPANY_NAME; ?>/mileage/view_driver_mileage_report/<?php echo $driver_id; ?>?date_from="+$date_from+'&date_to='+$date_to+'&ride_id='+$ride_id;
		});
	});
						...
						<div class="">
							<div class=" filter_wrap">
								<div class="widget_top filter_widget">
									...
									<form method="get" id="filter_form" action="<?php echo COMPANY_NAME; ?>/mileage/view_driver_mileage/<?php echo $driver_id; ?>" accept-charset="UTF-8">
									...
									<input name="date_to" id="date_to" type="hidden" value="<?php if(isset($end_date)) echo $end_date; ?>"  />
										...
										<a href="<?php echo COMPANY_NAME; ?>/mileage/view_driver_mileage/<?php echo $driver_id; ?><?php echo $urlVal; ?>" class="tipTop filterbtn" original-title="<?php if ($this->lang->line('driver_enter_view_all_users') != '') echo stripslashes($this->lang->line('driver_enter_view_all_users')); else echo 'View All Users'; ?>">
                    ...
                    <table class="display" id="mileage_view">
                        <thead>
                            <tr>
                               ...
                               <th class="tip_top" title="<?php if ($this->lang->line('dash_click_sort') != '') echo stripslashes($this->lang->line('dash_click_sort')); else echo 'Click to sort'; ?>">
                                ...
                                <th class="tip_top" title="<?php if ($this->lang->line('dash_click_sort') != '') echo stripslashes($this->lang->line('dash_click_sort')); else echo 'Click to sort'; ?>">
                                     <?php if ($this->lang->line('admin_drivers_mileage_view_duration') != '') echo stripslashes($this->lang->line('admin_drivers_mileage_view_duration')); else echo 'Duration'; ?>
										  </th>
                                <th class="tip_top" title="<?php if ($this->lang->line('dash_click_sort') != '') echo stripslashes($this->lang->line('dash_click_sort')); else echo 'Click to sort'; ?>">
                                    <?php if ($this->lang->line('admin_drivers_mileage_view_distance') != '') echo stripslashes($this->lang->line('admin_drivers_mileage_view_distance')); else echo 'Distance'; ?>
												(<?php if ($this->lang->line('admin_drivers_mileage_kilometer') != '') echo stripslashes($this->lang->line('admin_drivers_mileage_kilometer')); else echo $d_distance_unit_name;?>)
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th>
                                    <?php if ($this->lang->line('admin_drivers_mileage_view_distance') != '') echo stripslashes($this->lang->line('admin_drivers_mileage_view_distance')); else echo 'Distance'; ?> (<?php if ($this->lang->line('admin_drivers_mileage_kilometer') != '') echo stripslashes($this->lang->line('admin_drivers_mileage_kilometer')); else echo $d_distance_unit_name;?>)
                                </th>
