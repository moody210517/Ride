...
$(document).ready(function(){
    $("#export_report").click(function(event){  
		...
		window.location.href = "<?php echo COMPANY_NAME;?>/drivers/display_drivers_list?" + query_strings + "&export=excel";
	});
    
    $("#export_report_all").click(function(event){
		event.preventDefault();
		var query_strings = "<?php echo $_SERVER["QUERY_STRING"]; ?>";
		window.location.href = "<?php echo COMPANY_NAME;?>/drivers/display_drivers_list?" + query_strings + "&export=all";
	});
...
<div id="content" class="first-disply-list">
    <div class="grid_container">
						...
						<div class="">
							<div class=" filter_wrap">
								<div class="widget_top filter_widget display_filter_wp">
									...
									echo form_open(COMPANY_NAME.'/drivers/display_drivers_list', $attributes)
									?>
                                    ...
                                    <div class="btn_30_light second-row">
                                        ...
                                        <div class="filterwrap f-submint">
                                            ...
                                            <a href="<?php echo COMPANY_NAME;?>/drivers/display_drivers_list"class="tipTop filterbtn" original-title="<?php if ($this->lang->line('admin_notification_remove_filter') != '') echo stripslashes($this->lang->line('admin_notification_remove_filter')); else echo 'Remove Filter'; ?>">
        ...
        echo form_open(COMPANY_NAME.'/drivers/change_driver_status_global', $attributes)
        ?>
        <div class="grid_12">
                                    ...
                                    <tr style="border-bottom: 1px solid #dddddd !important;">
                                        ...
                                        <td class="center" style="20px;">
                                            <?php if (isset($row->avg_review)) { ?>
                                                <?php if ($row->avg_review != '') { ?>
                                                    <a href="<?php echo COMPANY_NAME;?>/reviews/view_driver_reviews/<?php echo $row->_id; ?>" style="color:blue;" ><?php echo number_format($row->avg_review, 2) . ' (' . $row->total_review . ')'; ?></a>
                                                <?php } else { ?>
                                                    0 (0)
                                                    <?php
                                                }
                                        ...
                                        <td class="center">
											...
											if (isset($row->mode)) {
													...
													$mode = '0';
												?>
												   <a title="<?php if ($this->lang->line('common_click_to_make_available') != '') echo stripslashes($this->lang->line('common_click_to_make_available')); else echo 'Click to make available'; ?>" class="tip_top" href="javascript:confirm_status('<?php echo COMPANY_NAME;?>/drivers/change_driver_mode_status/<?php echo $mode; ?>/<?php echo $row->_id; ?>');">
                                        ...
                                        <td class="center">
                                            ...
                                            if ($allPrev == '1' || in_array('2', $driver)) {
                                                ...
                                                if ($mode == '0') {
                                                    ?>
                                                    <a title="<?php if ($this->lang->line('common_click_to_unverify') != '') echo stripslashes($this->lang->line('common_click_to_unverify')); else echo 'Click to Unverify'; ?>" class="tip_top" href="javascript:confirm_status('<?php echo COMPANY_NAME;?>/drivers/change_driver_vrification_status/<?php echo $mode; ?>/<?php echo $row->_id; ?>');">
                                                        <span class="badge_style b_done"><?php echo $verify_status; ?></span>
                                                    </a>
                                                    <?php
                                                } else if ($mode == '1') {
                                                    ?>
                                                    <a title="<?php if ($this->lang->line('common_click_to_verify') != '') echo stripslashes($this->lang->line('common_click_to_verify')); else echo 'Click to verify'; ?>" class="tip_top" href="javascript:confirm_status('<?php echo COMPANY_NAME;?>/drivers/change_driver_vrification_status/<?php echo $mode; ?>/<?php echo $row->_id; ?>')">
                                        ...
                                        <td class="center">
                                            ...
                                            if ($allPrev == '1' || in_array('2', $driver)) {
                                                ...
                                                if ($mode == '0') {
                                                    ?>
                                                    <a title="<?php if ($this->lang->line('common_click_to_inactive') != '') echo stripslashes($this->lang->line('common_click_to_inactive')); else echo 'Click to inactive'; ?>" class="tip_top" href="javascript:confirm_status('<?php echo COMPANY_NAME;?>/drivers/change_driver_status/<?php echo $mode; ?>/<?php echo $row->_id; ?>');">
                                                        <span class="badge_style b_done"><?php echo $disp_status; ?></span>
                                                    </a>
                                                    <?php
                                                } else if ($mode == '1') {
                                                    ?>
                                                    <a title="<?php if ($this->lang->line('common_click_to_active') != '') echo stripslashes($this->lang->line('common_click_to_active')); else echo 'Click to active'; ?>" class="tip_top" href="javascript:confirm_status('<?php echo COMPANY_NAME;?>/drivers/change_driver_status/<?php echo $mode; ?>/<?php echo $row->_id; ?>')">
                                        ...
                                        <td class="center action-icons-wrap">
                                            <?php if ($allPrev == '1' || in_array('2', $driver)) { ?>
                                                <span><a class="action-icons c-bank" href="<?php echo COMPANY_NAME;?>/drivers/banking/<?php echo $row->_id; ?>" title="<?php if ($this->lang->line('driver_connect_banking') != '') echo stripslashes($this->lang->line('driver_connect_banking')); else echo 'Connect Banking'; ?>"><?php if ($this->lang->line('driver_connect_banking') != '') echo stripslashes($this->lang->line('driver_connect_banking')); else echo 'Connect Banking'; ?></a></span>
                                                <span><a class="action-icons c-key" href="<?php echo COMPANY_NAME;?>/drivers/change_password_form/<?php echo $row->_id; ?>" title="<?php if ($this->lang->line('driver_change_password') != '') echo stripslashes($this->lang->line('driver_change_password')); else echo 'Change Password'; ?>"><?php if ($this->lang->line('admin_common_edit') != '') echo stripslashes($this->lang->line('admin_common_edit')); else echo 'Edit'; ?></a></span>
                                                <span><a class="action-icons c-edit" href="<?php echo COMPANY_NAME;?>/drivers/edit_driver_form/<?php echo $row->_id; ?>" title="<?php if ($this->lang->line('admin_common_edit') != '') echo stripslashes($this->lang->line('admin_common_edit')); else echo 'Edit'; ?>"><?php if ($this->lang->line('admin_common_edit') != '') echo stripslashes($this->lang->line('admin_common_edit')); else echo 'Edit'; ?></a></span>
                                            <?php } ?>
                                            <span><a class="action-icons c-suspend" href="<?php echo COMPANY_NAME;?>/drivers/view_driver/<?php echo $row->_id; ?>" title="<?php if ($this->lang->line('admin_common_view') != '') echo stripslashes($this->lang->line('admin_common_view')); else echo 'View'; ?>"></a></span>
                                            <?php if ($allPrev == '1' || in_array('3', $driver)) { ?>	
                                                <?php if ($row->status != 'Deleted') { ?>
                                                    <span><a class="action-icons c-delete" href="javascript:confirm_delete('<?php echo COMPANY_NAME;?>/drivers/delete_driver/<?php echo $row->_id; ?>')" title="<?php if ($this->lang->line('admin_common_delete') != '') echo stripslashes($this->lang->line('admin_common_delete')); else echo 'Delete'; ?>"></a></span>
                                                <?php } ?>
                                            <?php } ?>
                                        </td>
                                    </tr>
