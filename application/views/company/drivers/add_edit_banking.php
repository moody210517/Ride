			...
			<div class="grid_12">
				<div class="widget_wrap">
					...
					<div class="widget_content">
						<form class="form_container left_label" action="<?php echo COMPANY_NAME; ?>/drivers/insertEditDriverBanking" id="addeditdriverbank_form" method="post" enctype="multipart/form-data">
							<div>
								<ul>
									<li>
