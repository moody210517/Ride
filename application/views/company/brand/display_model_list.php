...
<div id="content">
		<div class="grid_container">
			<?php 
				...
				echo form_open(COMPANY_NAME.'/brand/change_model_status_global',$attributes) 
			?>
			<div class="grid_12">
						...
						<table class="display display_tbl" id="model_tbl">
							...
							<tbody>
								...
								if ($modelList->num_rows() > 0){
									foreach ($modelList->result() as $row){ $i++;
								?>
								<tr>
