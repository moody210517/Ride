...
?>
<div id="content" class="admin-settings edit_model_company">
        ...
        <div class="grid_12">
            <div class="widget_wrap">
                ...
                <div class="widget_content chenge-pass-base">
                    <form class="form_container left_label" action="<?php echo COMPANY_NAME;?>/brand/insertEditModel" id="addeditmodel_form" method="post" enctype="multipart/form-data">
                        <div>
