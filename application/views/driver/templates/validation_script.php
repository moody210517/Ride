...
var required_txt = "<?php if(array_key_exists('required',$validationArr)){ echo $validationArr['required']; }else { echo "This field is required.";} ?>";
	...
	var onlyalphabets_txt = "<?php if(array_key_exists('onlyalphabets',$validationArr)){ echo $validationArr['onlyalphabets']; }else { echo "Please enter only alpha alphabets.";} ?>";
</script>