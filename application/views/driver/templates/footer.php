		...
		<div class="row">
			<div class="col-md-4 col-lg-4">
				<div class="keepintouch">
					<h2><?php if ($this->lang->line('login_footer_keep_in_touch') != '')
                                    echo stripslashes($this->lang->line('login_footer_keep_in_touch'));
                                        else  echo 'Keep in touch';
                                            ?> </h2>
					<div class="head_border"></div>
					<ul>
						<?php if ($this->config->item('site_contact_address') != '') { ?>
						<li class="f_address">
							<a href="javascript:void(0);"><?php echo $this->config->item('site_contact_address');?></a>
						</li>
						<?php  } ?>
						
						<?php if ($this->config->item('site_contact_mail') != '') { ?>
						<li class="f_mail">
							<a href="javascript:void(0);"><?php echo $this->config->item('site_contact_mail');?></a>
						</li>
						<?php  } ?>
						
						<?php if ($this->config->item('customer_service_number') != '') { ?>
						<li class="f_number">
							<a href="javascript:void(0);"><?php echo $this->config->item('customer_service_number');?></a>
						</li>
						<?php } ?>
						
						<li class="f_website">
							<a href="javascript:void(0);"><?php echo substr(base_url(),0,-1); ?></a>
						</li>
					</ul>
				</div>
			</div>
					...
					<div class="download_app_part">
						<ul>
							<li class="footer_gooply">
								<a <?php if($user_playstore_link != '' ){ ?>href="<?php echo $user_playstore_link; ?>" <?php } ?>> <img src="images/site/footer_google_play.png"> </a>
							</li>
							<li class="footer_plystr">
								<a <?php if($user_appstore_link != '' ){ ?>href="<?php echo $user_appstore_link; ?>" <?php } ?>> <img src="images/site/footer_play_store.png"></a>
							</li>
						</ul>
					</div>
			...
			<div class="col-md-4 col-lg-4">
				...
				<h2><?php if ($this->lang->line('login_footer_information') != '')
                                    echo stripslashes($this->lang->line('login_footer_information'));
                                        else  echo 'INFORMATION';
                                            ?>  </h2>
				<div class="head_border"></div>
					<ul>
						<?php if($footer_home == 'yes'){ ?>
						  <li><a href="<?php echo base_url(); ?>"><?php if ($this->lang->line('footer_home') != '')
                                    echo stripslashes($this->lang->line('footer_home'));
                                        else  echo 'Home';
                                            ?>   </a></li>
						<?php } ?>
