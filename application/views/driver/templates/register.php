	...
	<div  class="profile_login_cont">
		...
		<div class="share_detail dirver_reg_form">
			...
			<?php 
				...
				echo form_open('driver/profile/register',$formArr);
			?>
							...
							<?php 
								...
								foreach ($countryList as $country) {  
									...
									if($country->dial_code == $driver_data->row()->dail_code){
										if($d_country_cca3==$country->cca3)
										{
										$optkey = $optkey.'" selected=selected';
										}
									}
									$drop_options[$optkey]=$country->name;//print_R($drop_options);die;
					  ...
					  <div class="col">
						 <li>
							...
							<?php 
								...
								echo form_input($input_data);
							?>
							<p class="error_chk error" id="vehicle_number_exist"></p>
						 </li>
						...
						<input type="hidden" name="additional_category" value="<?php echo @implode(',',$additonalCatsId)?>">
						 ...
						 <div class="col docu_sub">
							<li>
							   ...
							   <input type="button" value="<?php if($this->lang->line('driver_save_information') != '') echo stripslashes($this->lang->line('driver_save_information')); else  echo 'Save Information'; ?>" id="btnSave" onclick="submit_reg_form();">
							</li>
						 </div>
				   </div>
				</div>
            ...
            $.ajax({
                ...
                success: function(res) {
                    ...
                    if (res.status == '1') {
                        ...
                        $('#vehicle_number_exist').addClass('errornumber');
