...
<style>
	...
	form.msform div#init_box_country_code_chosen{float:left;width:100% !important; background:#fff !important;}
</style>
			...
			<div class="row">
				...
				<div class="col-md-6 col-lg-6">
					<div class="driver_register_form">
						...
						echo form_open('site/app_driver/temp_register',$formArr);
						?>
