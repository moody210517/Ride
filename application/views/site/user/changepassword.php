<?php 
$this->load->view('site/templates/profile_header.php');
?>
   ...
   <div class="profile_ac_inner_det">
      <div class="inner_full editprofile">
         <p class="form_sub_title"><?php
                                    if ($this->lang->line('user_password_information') != '')
                                        echo stripslashes($this->lang->line('user_password_information'));
                                    else
		 ...
		 <?php 
				...
				echo form_open('site/rider/change_password',$attributes) 
			?>
			...
			<div class="col">
				...
				<li>
					<p><?php if ($this->lang->line('user_confirm_password') != '') echo stripslashes($this->lang->line('user_confirm_password')); else echo 'Confirm Password'; ?></p>
